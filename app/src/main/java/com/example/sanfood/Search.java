...
public class Search extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            try {
                ...
                e.printStackTrace();
                Log.e("MainActivity", "Error launching RecipeDetails: " + e.getMessage());
                Toast.makeText(Search.this, "Error launching RecipeDetails", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                // You can choose to perform a real-time search as the user types
                // makeJsonObjectRequest(newText);
                return false;
            }
        });
    }
    ...
    private void makeJsonObjectRequest(String query) {
        ...
        // Append the user-entered query to the API URL
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    // Check if the "meals" array exists in the response
